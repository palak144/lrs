...
export class LeaveApprovalService {
  ...
  constructor(private _http: HttpClient, private _global: GlobalService) {
    this._global.showConsoleLog('constructor of Leave Approval Service', '');
  }
  ...
  pendingLeavesApprovals(req): Observable<any> {
    return this._http.post<any>(this._global.apiBaseURL + 'allPendingApprovalLeaves', req, this.httpOptions)
      .do((data) => {
